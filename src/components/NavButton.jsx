...
export default function NavButton(props) {
    return (
        <button className="bg-transparent nav-hover md:flex p-2 md:mx-2 md:my-2 items-center md:float-right">
            <span className="text-dark md:mr-3 font-bold min:hidden md:inline-block">{props.text}</span>
