...
function BigName() {
  return (
    <div className="font-display my-8 xs:mx-3 sm:mx-0 leading-none font-semibold md:dark:text-shadow-md xs:dark:text-shadow-min">
      <div>
        ...
        <div className="flex md:text-xs big-text-sec xs:ml-2 sm:ml-1 xl:ml-4 sm:mt-2">
